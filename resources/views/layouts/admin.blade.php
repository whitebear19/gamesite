    ...
    <div class="sidebar">      
      ...
      <nav class="mt-2">
        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.dashboard') }}" class="nav-link @if ($nav == 'dashboard') active @endif">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.games') }}" class="nav-link  @if ($nav == 'games') active @endif">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.category') }}" class="nav-link  @if ($nav == 'category') active @endif">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.compatible') }}" class="nav-link  @if ($nav == 'compatible') active @endif">
          ...
          <li class="nav-item">
            <a href="{{ route('admin.oasis') }}" class="nav-link  @if ($nav == 'oasis') active @endif">
